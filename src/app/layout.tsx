...
export const metadata: Metadata = {
  title: "Custom Coffee Mugs Dropshipping - MugCraft",
  description: "Start your dropshipping business selling custom coffee mugs. Zero inventory, fast shipping, premium quality. 50K+ orders shipped worldwide.",
  keywords: "dropshipping mugs, custom coffee mugs, print on demand, coffee mug supplier",
  openGraph: {
    title: "Custom Coffee Mugs Dropshipping - MugCraft",
    description: "Start your dropshipping business selling custom coffee mugs. Zero inventory, fast shipping, premium quality.",
    siteName: "MugCraft",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765113001675-mg4lfd4u.jpg",
      alt: "Premium coffee mugs collection"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Custom Coffee Mugs Dropshipping - MugCraft",
    description: "Start your dropshipping business selling custom coffee mugs. Zero inventory, fast shipping.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765113001675-mg4lfd4u.jpg"]
  }
};
